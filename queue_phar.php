...
// Get pending queues - now ordered by priority
...
<body>
  <!-- Left Side Panel - Pending Results (now with priority indicators) -->
  <div class="side-panel">
    <div class="card">
      <div class="card-header">
        <span>Pending Results</span>
        <span class="badge"><?= count($pendingQueues) ?> pending</span>
      </div>
      <div class="card-body">
        <?php foreach ($pendingQueues as $q): 
          $priorityClass = 'priority-' . strtolower($q['priority']);
        ?>
          <div class="queue-item">
            <div style="display: flex; align-items: center; gap: 8px;">
              <span class="queue-item-number"><?= $q['queue_num'] ?></span>
              <span class="queue-item-priority <?= $priorityClass ?>">
                <?= ucfirst(str_replace('_', ' ', $q['priority'])) ?>
              </span>
            </div>
    ...
    <div class="card current-queue">
      ...
      <?php if ($currentQueue): ?>
        <div class="queue-details">
          ...
          <div>
            <span class="queue-item-priority priority-<?= strtolower($currentQueue['priority']) ?>">
  ...
  <div class="side-panel">
    <div class="card">
      <div class="card-header">
        <span>Postponed</span>
        <span class="badge"><?= count($postponedQueues) ?> postponed</span>
      </div>
      <div class="card-body">
